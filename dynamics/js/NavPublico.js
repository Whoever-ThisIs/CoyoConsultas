//Favicon
$("head").append("<link rel='shortcut icon' href='../statics/media/favi/faviconlogo.png' type='image/x-icon'>")
$("head").append("<link rel='icon' href='../statics/media/favi/faviconlogo.png' type='image/x-icon'>")
